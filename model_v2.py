...
class Actor(nn.Module):
    ...
    def reset_parameters(self):
        ...
        self.fc1_bn.weight.data.uniform_(*hidden_init(self.fc1_bn))         
        self.fc2.weight.data.uniform_(*hidden_init(self.fc2))  
        self.fc2_bn.weight.data.uniform_(*hidden_init(self.fc2_bn))           
...
class Critic(nn.Module):
    ...
    def reset_parameters(self):
        ...
        self.fcs1_bn.weight.data.uniform_(*hidden_init(self.fcs1_bn))
        self.fc2.weight.data.uniform_(*hidden_init(self.fc2))            
        self.fc3.weight.data.uniform_(-3e-3, 3e-3)
